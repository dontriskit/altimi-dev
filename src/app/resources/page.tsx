...
import { CTA_URL } from "../_lib/constants";

export const metadata: Metadata = {
  title: "Resources - Altimi Modernization Insights",
  description: "Research-backed articles on legacy modernization, AI-augmented development, and phased migration strategies.",
};
...
async function getArticles(): Promise<Article[]> {
  try {
    ...
    return data.articles
      .filter((a) => a.target_site === "altimi-dev.com" && a.assembly_status === "completed")
    ...
    <>
      ...
      <section className="bg-white">
        <div className="max-w-[1540px] mx-auto px-[105px] max-md:px-6 py-[100px] max-md:py-[60px]">
          ...
          <h1 className="text-[clamp(28px,4vw,48px)] leading-[1.15] font-normal text-[#0a1926] mb-4 max-w-[700px]">
            Data-Driven Modernization Insights
          </h1>
          <p className="text-[#333333] text-[18px] leading-[1.6] mb-[80px] max-md:mb-[50px] max-w-[700px]">
            Research-backed articles with original data, charts, and sourced
            citations. Each piece is built from 3 parallel deep research
            streams and reviewed for accuracy.
          </p>

          {articles.length === 0 ? (
            <p className="text-[#333333] text-[16px]">Articles coming soon.</p>
          ) : (
                ...
                return (
                  ...
                  >
                    <div className={isEven ? "md:order-2" : ""}>
                      ...
                      <h2 className="text-[clamp(22px,3vw,36px)] leading-[1.2] font-normal text-[#0a1926] mb-4 group-hover:text-[#419AF0] transition-colors">
                        {a.title}
                      </h2>
          ...
          <div className="mt-[80px] max-md:mt-[50px] text-center">
